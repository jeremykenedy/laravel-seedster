...
it('runs a seeder a package registered with the handler', function (): void {
...
it('falls back to the application database seeder when no class is given', function (): void {
    class_alias(RootSeeder::class, 'Database\\Seeders\\DatabaseSeeder');
